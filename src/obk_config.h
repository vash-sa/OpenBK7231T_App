...
// #define ENABLE_SEND_POSTANDGET				0
#define ENABLE_HA_DISCOVERY 					1
#define ENABLE_MQTT								1
#define ENABLE_TASMOTADEVICEGROUPS				0
#define ENABLE_LITTLEFS							1
#define ENABLE_NTP								1
// #define ENABLE_TIME_DST						0
#define ENABLE_CALENDAR_EVENTS					1
#define ENABLE_DRIVER_LED						1
...
#define ENABLE_DRIVER_NEO6M						0
#define ENABLE_DRIVER_TINYIR_NEC				0
